...
class WebsocketHandler:
    ...
    async def speech_to_text(self,
        ...
        if mic is None:
            return { "success": False, "errorMsg": "Microphone not initialized." }
...
def main():
    ...
    try:
        ...
        logging.error("Please check if a microphone is connected and that the application has the necessary permissions.")
        sys.exit(1)
